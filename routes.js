...
router.get('/map', asyncRoute(async (req, res) => {
    const [maps, eventTypes] = await Promise.all([dbHandler.getMaps(), dbHandler.getMapEventTypes()]);
